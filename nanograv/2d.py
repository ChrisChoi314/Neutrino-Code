...
for i in range(3):
    ax1.plot(M_arr[partition_idx_low[2*i]:partition_idx_low[2*i+1]], omega_arr[0][partition_idx_low[2*i]:partition_idx_low[2*i+1]] , color = 'orange', alpha = 0.7-i*0.2, linewidth = lw+thicker)
    ax1.plot(M_arr[partition_idx_low[2*i]:partition_idx_low[2*i+1]], omega_arr[1][partition_idx_low[2*i]:partition_idx_low[2*i+1]] , color = 'orange', alpha = 0.7-i*0.2, linewidth = lw+thicker)

#ax1.plot(M_arr[omega_arr[0] < Omega_sig_f_low[1] and omega_arr[0] > Omega_sig_f_low[0]], omega_arr[0][(omega_arr[0] < Omega_sig_f_low[1] and omega_arr[0] > Omega_sig_f_low[0])], alpha=0.7, color= 'orange')
...
for i in range(3):
    ax3.plot(H_inf[partition_idx_low[2*i]:partition_idx_low[2*i+1]], omega_arr[0][partition_idx_low[2*i]:partition_idx_low[2*i+1]] , color = 'orange', alpha = 0.7-i*0.2, linewidth = lw+thicker)
    ax3.plot(H_inf  [partition_idx_low[2*i]:partition_idx_low[2*i+1]], omega_arr[1][partition_idx_low[2*i]:partition_idx_low[2*i+1]] , color = 'orange', alpha = 0.7-i*0.2, linewidth = lw+thicker)
...
ax3.annotate(r'$m = H_{\mathrm{inf}}, \tau_m = 10^{27}\tau_r$', xy=(0.05,0.15),xycoords='axes fraction',fontsize=fs)
ax3.annotate(r'$f_{\mathrm{low}}$', xy=(0.5,0.35),xycoords='axes fraction',fontsize=fs)
ax3.annotate(r'$f_{\mathrm{high}}$', xy=(0.55,0.52),xycoords='axes fraction',fontsize=fs)
